...
export default function SettingsPage() {
    ...
    const fetchSettings = async () => {
      try {
        const [generalRes, securityRes, notificationsRes, systemRes] = await Promise.all([
          fetch('api.yashrajent.com/api/settings/general'),
          fetch('api.yashrajent.com/api/settings/security'),
          fetch('api.yashrajent.com/api/settings/notifications'),
          fetch('api.yashrajent.com/api/settings/system')
        ]);
  ...
  const handleSaveSettings = async (category) => {
    setLoading(true);
    try {
      const response = await fetch(`api.yashrajent.com/api/settings/${category}`, {
        method: 'PUT',
        headers: {
